...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', type=int, default=12, help="number of processes to use")
    parser.add_argument('-n', action="store_true", default=False)
    parser.add_argument('-z', action="store_true", default=False)
    parser.add_argument('-d', type=str, default='test')
    parser.add_argument('-pkl_name', type=str, default='cv/normal/model.npz', help="name of pickle file (without the .pkl)")
    parser.add_argument('-model', type=str, default='cv/normal/model.npz_epoch_19.npz')
    parser.add_argument('-saveto', type=str, default='gensaps')
